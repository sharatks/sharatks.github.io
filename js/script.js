...
$(function() {
  ...
  var videoHolder = $(parent).find('#videoHolder');
  var videoPlayBtn = $(videoHolder).find('#videoPlay');

  function playVideo(event, videoHolder, videoPlayBtn) {
    event.preventDefault();
    // $(videoHolder).children('.background-img-holder').remove();
    // $(videoPlayBtn).remove();
    // $('#bgndVideo').YTPPlay();
    // $(videoHolder).find('#controlBar_bgndVideo').addClass('visible');
  }
  ...
  $(parent).on('click', function(event) {
    ...
    } else if (event.target.hash === '#videoPlay' || event.target.classList.contains('videoPlay')) {
      playVideo(event, videoHolder, videoPlayBtn);
    }
  });
});
...
/* ------------------------------------- */
/* Subscribe Form for Email   ................... */
/* ------------------------------------- */
  //
  // $(function() {
  // 	// Get the form.
  // 	var $form = $('#subscribe-form-email');
  // 	// Get the messages div.
  //   var $resultElement = $('#subscribe-result');
  //
